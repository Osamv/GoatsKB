...
import ARTICLES_DATA from "./Article";
import {
  Search,
  Menu,
  X,
        ...
        <div className="flex justify-between items-center h-16">
          <div className="flex items-center space-x-8">
            ...
            <div className="hidden md:flex space-x-6">
              <button
                onClick={onHomeClick}
                className="flex items-center space-x-1 text-gray-300 hover:text-[#FF6A39] transition-colors"
              >
        ...
        <div className="relative z-10 px-6 py-24 sm:py-32 lg:px-8">
          <div className="text-center">
            ...
            <p className="mt-6 text-lg leading-8 text-gray-300">
              Our resource library ?? is more than enough… the other sites are
            ...
            <div className="mt-10 flex items-center justify-center gap-x-6">
              <a
                href="#articles"
                className="rounded-md bg-[#36454F] px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-[#ff7d4f] transition-all"
              >
                Browse Articles
              </a>
    ...
    <div className="flex gap-8 relative">
      ...
      <main className="flex-1 max-w-4xl">
        ...
        <div className="flex items-center space-x-2 text-sm text-gray-400 mb-6">
          <button onClick={onHomeClick} className="hover:text-[#FF6A39]">
            Home
          </button>
        ...
        <div className="space-y-6">
          ...
          {article.content.businessRules.length > 0 && (
            <details className="group bg-[#1D252D] border border-gray-700 rounded-xl shadow-lg overflow-hidden">
              <summary className="flex items-center justify-between cursor-pointer list-none px-5 py-4 hover:bg-gray-800/60 transition-colors">
                <div>
                  ...
                  <span className="text-xs text-gray-400">
                    {article.content.businessRules.length} rules
                  </span>
                </div>
              ...
              <div className="px-5 pb-5">
                <ul className="space-y-3 mt-2">
                  {article.content.businessRules.map((item, idx) => (
                    <li
                      key={idx}
                      className="flex items-start space-x-3 text-gray-200"
                    >
                      <span className="text-[#FF6A39] font-bold mt-1">•</span>
                      <span className="leading-relaxed">{item}</span>
                    </li>
                  ))}
                </ul>
  ...
  <footer className="bg-[#1D252D] border-t border-gray-800 text-white mt-16">
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        <div>
          <h3 className="text-lg font-bold mb-4 text-[#FF6A39]">
            Knowledge Bank
          </h3>
        ...
        <div>
          ...
          <ul className="space-y-2 text-gray-400">
            <li>
              <a
                href="#home"
                className="hover:text-[#FF6A39] transition-colors"
              >
                Home
              </a>
            </li>
